        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-3">
              <Link href="#" className="text-gray-400 hover:text-gray-200"><FaFacebook size={20} /></Link>
              <Link href="#" className="text-gray-400 hover:text-gray-200"><FaTwitter size={20} /></Link>
              <Link href="https://www.linkedin.com/in/vikasprins/" className="text-gray-400 hover:text-gray-200"><FaLinkedin size={20} /></Link>
              <Link href="https://github.com/Vikasprins" className="text-gray-400 hover:text-gray-200"><FaGithub size={20} /></Link>
            </div>
          </div>
        </div>
