      ...
      <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4">
        ...
        <div className="bg-gray-200 p-6 rounded-lg">
          ...
          <form className="mt-8 space-y-4">
            ...
            <button type='button'
              className="text-white bg-[#045e52] hover:bg-green-950 cursor-pointer tracking-wide rounded-lg text-sm font-medium px-4 py-3 flex items-center justify-center w-full !mt-6">
