      ...
      <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4">
        ...
        <div className="bg-gray-200 p-6 rounded-lg">
          ...
          <div className="space-y-4 max-lg:mt-4">
            <button type="button" className="px-4 py-2 rounded-lg bg-[#045e52] text-white text-sm tracking-wider font-medium outline-none border-2  mr-4">Web design</button>
          ...
          <form className="mt-8 space-y-4">
            <input type='text' placeholder='Name'
              className="w-full rounded-lg py-3 px-4 text-slate-900 text-sm outline-none border border-[#045e52]" />
            <input type='email' placeholder='Email'
              className="w-full rounded-lg py-3 px-4 text-slate-900 text-sm outline-none border border-[#045e52]" />
            <input type='text' placeholder='Subject'
              className="w-full rounded-lg py-3 px-4 text-slate-900 text-sm outline-none border border-[#045e52]" />
            <textarea placeholder='Message' 
              className="w-full rounded-lg px-4 text-slate-900 text-sm pt-3 outline-none border border-[#045e52]"></textarea>
            <button type='button'
              className="text-white bg-[#045e52] hover:bg-[#a91079e2] tracking-wide rounded-lg text-sm font-medium px-4 py-3 flex items-center justify-center w-full !mt-6">
